...
public class DmnDefinitionsTriggerTypeIdResolver extends TypeIdResolverBase {

  @Override
  public String idFromValue(Object value) {
    return switch (value) {
      case XmlDmnDefinitionsDTO ignored -> "X";
  ...
  public JavaType typeFromId(DatabindContext context, String id) {
    return switch (id) {
      case "X" -> context.constructType(XmlDmnDefinitionsDTO.class);
