...
docker run -it -v ./config:/app/config -e quarkus.config.locations=file:/app/config/kafka-dockerlocal.properties -e tenant=tenant -e namespace=namespace  ghcr.io/qunit/taktx-engine:1.0.0
