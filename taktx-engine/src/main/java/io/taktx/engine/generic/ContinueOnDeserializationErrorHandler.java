 ...
 *
 * <p>A deserialization failure in Kafka Streams (e.g. a corrupt CBOR payload, a null/malformed UUID
 * key, or a signing-aware Serde rejection) would by default stop the affected stream thread with
