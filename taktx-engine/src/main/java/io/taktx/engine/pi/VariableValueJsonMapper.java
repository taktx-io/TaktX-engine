...
/** Temporary bridge between legacy Jackson DTOs and proto-backed variable values. */
public final class VariableValueJsonMapper {

  private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();

  private VariableValueJsonMapper() {}
