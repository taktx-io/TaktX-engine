...
@ApplicationScoped
@NoArgsConstructor
public class MessageEndEventInstanceProcessor
    extends ExternalTaskInstanceProcessor<MessageEndEvent, MessageEndEventInstance> {
  @Inject
  public MessageEndEventInstanceProcessor(
