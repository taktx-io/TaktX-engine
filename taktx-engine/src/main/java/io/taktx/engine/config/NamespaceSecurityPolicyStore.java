...
public class NamespaceSecurityPolicyStore {
  ...
  private final AtomicReference<NamespaceSecurityPolicyDTO> authoritativePolicy =
  ...
  public synchronized NamespaceSecurityPolicyDTO get() {
    return authoritativePolicy.get();
  }
