...
public class ReplyProducer {
  ...
  KafkaProducer<ScheduleKey, ProcessInstanceTrigger> producer;
  ...
  public void send(ProducerRecord<ScheduleKey, ProcessInstanceTrigger> producerRecord) {
    producer
        .runOnSendingThread(
            (Consumer<Producer<ScheduleKey, ProcessInstanceTrigger>>)
