...
public class ProcessResource {
    ...
    public void start(@RestPath String processId, @RestPath Integer gen, @RestPath Integer version, @RestPath String elementId, String variables) {
        ...
        try {
            ...
            throw new RuntimeException("Failed to parse variables", e);
        }
        ProcessDefinitionKey processDefinitionKey = new ProcessDefinitionKey(processId, gen, version);
