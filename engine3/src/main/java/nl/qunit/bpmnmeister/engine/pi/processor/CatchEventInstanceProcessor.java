...
public abstract class CatchEventInstanceProcessor<
  ...
  protected InstanceResult processStartSpecificEventInstance(
    ...
    return processStartSpecificCatchEventInstance(flowElements, flowNodeInstance, variables);
  }

  protected abstract InstanceResult processStartSpecificCatchEventInstance(
