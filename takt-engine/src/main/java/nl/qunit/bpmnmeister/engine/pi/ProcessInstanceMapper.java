...
import nl.qunit.bpmnmeister.pi.state.v_1_0_0.BoundaryEventInstanceDTO;
import nl.qunit.bpmnmeister.pi.state.v_1_0_0.CallActivityInstanceDTO;
import nl.qunit.bpmnmeister.pi.state.v_1_0_0.EndEventInstanceDTO;
import nl.qunit.bpmnmeister.pi.state.v_1_0_0.ExclusiveGatewayInstanceDTO;
...
import nl.qunit.bpmnmeister.pi.state.v_1_0_0.InclusiveGatewayInstanceDTO;
import nl.qunit.bpmnmeister.pi.state.v_1_0_0.IntermediateCatchEventInstanceDTO;
import nl.qunit.bpmnmeister.pi.state.v_1_0_0.IntermediateThrowEventInstanceDTO;
import nl.qunit.bpmnmeister.pi.state.v_1_0_0.MultiInstanceInstanceDTO;
import nl.qunit.bpmnmeister.pi.state.v_1_0_0.ParallelGatewayInstanceDTO;
import nl.qunit.bpmnmeister.pi.state.v_1_0_0.ProcessInstanceDTO;
import nl.qunit.bpmnmeister.pi.state.v_1_0_0.ReceiveTaskInstanceDTO;
import nl.qunit.bpmnmeister.pi.state.v_1_0_0.SendTaskInstanceDTO;
import nl.qunit.bpmnmeister.pi.state.v_1_0_0.ServiceTaskInstanceDTO;
import nl.qunit.bpmnmeister.pi.state.v_1_0_0.StartEventInstanceDTO;
